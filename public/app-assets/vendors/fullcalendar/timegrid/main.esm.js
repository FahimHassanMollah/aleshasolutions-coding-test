...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    // Computes a admin event time formatting string if `eventTimeFormat` is not explicitly defined
    ...
    // Computes a admin `displayEventEnd` value if one is not expliclty defined
    TimeGridEventRenderer.prototype.computeDisplayEventEnd = function () {
        return true;
    };
    // Renders the HTML for a single event segment's admin rendering
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    /* Selection
    ------------------------------------------------------------------------------------------------------------------*/
    // Renders a visual indication of a selection. Overrides the admin, which was to simply render a highlight.
