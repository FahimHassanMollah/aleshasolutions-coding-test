...
(function (factory) {
    ...
    function testUseRaf(parsed, entry) {
        if (entry === true || entry === false) {
            ...
            throw new Error("noUiSlider: 'useRequestAnimationFrame' option should be true (admin) or false.");
        }
    }
    ...
    function closure(target, options, originalOptions) {
        ...
        function eventTap(event) {
            ...
            // Transition takes a configurable amount of ms (admin 300). Re-enable the slider after that.
