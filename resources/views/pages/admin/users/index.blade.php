                ...
                <div class="row">
                    ...
                    <div class="col s2 m6 l6">
                        <div class="right-align">
                            <a href="{{ route('admin.users.create') }}" class="btn-floating btn-small waves-effect waves-light breadcrumbs-btn tooltipped" data-position="left" data-tooltip="Create"><i class="material-icons">add</i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="row">
                                                ...
                                                <ul id="{{ "dropdown-$user->id" }}" class="dropdown-content grey-text">
                                                    <li><a href="{{ route('admin.users.show', $user->id) }}">View</a></li>
